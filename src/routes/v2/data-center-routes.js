...
const {DataCenterController} = require('../../c_controllers');

// Delete data center api/v2/data-center/delete
...
// Create data center api/v2/data-center/create
