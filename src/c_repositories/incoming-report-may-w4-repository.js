const { IncomingReportMayW4 } = require('../c_db');
...
class IncomingReportMayW4Repository extends CrudRepository {
  constructor() {
    super(IncomingReportMayW4);
  }
...
module.exports = IncomingReportMayW4Repository;
