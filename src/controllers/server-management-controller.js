...
const { ServerManagementRepository , UserJourneyRepository} = require("../repositories");
...
async function createServerManagement(req, res) {
    ...
    try {
      ...
      Logger.info(
        `Server Management -> created successfully: ${JSON.stringify(responseData)}`
      );
...
async function getAll(req, res) {
    try {
      ...
      Logger.error(
        `Server Management -> unable to get server list, error: ${JSON.stringify(error)}`
      );
...
async function updateServerManagement(req, res) {
    ...
    try {
      ...
      Logger.error(`Server Management-> unable to update server: ${uid}, data: ${JSON.stringify(bodyReq)}, error: ${JSON.stringify(error)}`);
...
async function deleteServerManagement(req, res) {
    ...
    try {
      ...
      Logger.error(
        `Server Management -> unable to delete server: ${idArray}, error: ${JSON.stringify(error)}`
      );
...
module.exports = {createServerManagement, getAll, getById, updateServerManagement, deleteServerManagement};
