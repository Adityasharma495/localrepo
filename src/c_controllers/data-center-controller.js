...
async function createDataCenter(req, res) {
  ...
  try {
    ...
    if (existingDataCenter) {
      ...
      let errorMsg =
        "Duplicate Data Center Name Found. Please use a different name";
    ...
    Logger.error(
      `Data Center -> unable to create: ${JSON.stringify(
        error,
...
async function getAll(req, res) {
  try {
    ...
    Logger.error(
      `Data Center -> unable to get data center list, error: ${JSON.stringify(
        error
      )}`
    );
...
async function updateDataCenter(req, res) {
  ...
  try {
    ...
    Logger.error(
      `Data Center-> unable to update Data Center: ${uid}, data: ${JSON.stringify(
        bodyReq
...
async function deleteDataCenter(req, res) {
  ...
  try {
    ...
    Logger.error(
      `Data center -> unable to delete center: ${idArray}, error: ${JSON.stringify(
        error
      )}`
    );
