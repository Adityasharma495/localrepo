const { IncomingReportJuneW1 } = require('../c_db');
...
class IncomingReportJuneW1Repository extends CrudRepository {
  constructor() {
    super(IncomingReportJuneW1);
  }
...
module.exports = IncomingReportJuneW1Repository;
