const { IncomingReportJuneW2 } = require('../c_db');
...
class IncomingReportJuneW2Repository extends CrudRepository {
  constructor() {
    super(IncomingReportJuneW2);
  }
...
module.exports = IncomingReportJuneW2Repository;
