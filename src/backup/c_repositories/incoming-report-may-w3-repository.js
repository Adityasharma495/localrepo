const { IncomingReportMayW3 } = require('../c_db');
...
class IncomingReportMayW3Repository extends CrudRepository {
  constructor() {
    super(IncomingReportMayW3);
  }
...
module.exports = IncomingReportMayW3Repository;
