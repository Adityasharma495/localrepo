const { IncomingReportJuneW3 } = require('../c_db');
...
class IncomingReportJuneW3Repository extends CrudRepository {
  constructor() {
    super(IncomingReportJuneW3);
  }
...
module.exports = IncomingReportJuneW3Repository;
