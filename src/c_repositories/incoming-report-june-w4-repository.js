const { IncomingReportJuneW4 } = require('../c_db');
...
class IncomingReportJuneW4Repository extends CrudRepository {
  constructor() {
    super(IncomingReportJuneW4);
  }
...
module.exports = IncomingReportJuneW4Repository;
