...
function getUserAccessRoles(user_role, permission_type) {
    ...
    switch (user_role) {
        ...
        case USERS_ROLE.RESELLER:
            userAccessRoles = {
                [PERMISSION_TYPES.READ]: [USERS_ROLE.COMPANY_ADMIN, USERS_ROLE.RESELLER],
                [PERMISSION_TYPES.CREATE]: [USERS_ROLE.COMPANY_ADMIN, USERS_ROLE.RESELLER],
                [PERMISSION_TYPES.UPDATE]: [USERS_ROLE.COMPANY_ADMIN, USERS_ROLE.RESELLER],
                [PERMISSION_TYPES.DELETE]: [USERS_ROLE.COMPANY_ADMIN, USERS_ROLE.RESELLER]
            }
            break;
