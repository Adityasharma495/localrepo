...
// router.post('/', AuthMiddleware.validateUser, CompanyMiddleware.validateCreate, CompanyController.create);
...
// router.post('/:id', AuthMiddleware.validateUser, CompanyMiddleware.validateCreate, CompanyController.updateCompany);
