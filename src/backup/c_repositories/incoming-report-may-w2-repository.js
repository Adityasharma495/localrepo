const { IncomingReportMayW2 } = require('../c_db');
...
class IncomingReportMayW2Repository extends CrudRepository {
  constructor() {
    super(IncomingReportMayW2);
  }
...
module.exports = IncomingReportMayW2Repository;
